...
export default function AudioGuestbook({ guest = "Flowen & Susan" }) {
  ...
  const sendMessage = () => {
    ...
    setTimeout(() => {
      ...
      // Message itokee juu ya screen kwa sekunde chache
    ...
    <div className="salamu">
      {sent && (
        <div className="popup-message">
          🎧 Asante! Ujumbe wako wa sauti umehifadhiwa.
        </div>
      )}
